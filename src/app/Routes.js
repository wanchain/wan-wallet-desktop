...
import { Layout, Portfolio, WanAccount, Settings, Trezor, Ledger, Delegation, Validator, Offline, TokenTrans, UpgradeContract, RegisterStoremanGroup, DexDeploy, JackpotDeploy, RegisterToken, E20TokenTrans, EthAccount, BtcAccount, EosAccount, CrossETH, CrossE20, CrossBTC, CrossEOS, Dex, DeployContract } from './containers';
      ...
      <HashRouter>
        <Main>
          <Switch>
            ...
            <Route path="/jackpotDeploy" component={JackpotDeploy} />
