const en_US = {
    ...
    'EOSAccountList.manageResource': 'Manage Resources',
    'EOSAccountList.getResourcePriceFailed': 'Get resource price failed',
    'EOSAccountList.eosResourceManagement': 'EOS Resource Management',
    ...
    'EOSResourceManageForm.enterRAMSizeToBuy': 'Enter RAM Size You Want To Buy ( KB )',
    'EOSResourceManageForm.selectReceivingAccount': 'Select Receiving Account',
    'EOSResourceManageForm.enterRAMSizeToSell': 'Enter RAM Size You Want To Sell ( KB )',
    'EOSResourceManageForm.oversizeCPU': 'Over the maximum size of CPU',
    'EOSResourceManageForm.noSufficientCPUToDelegate': 'No sufficient CPU to delegate',
    'EOSResourceManageForm.noSufficientCPUtoUndelegate': 'No sufficient CPU to undelegate',
    'EOSResourceManageForm.currentCPUPrice': 'Current CPU Price',
    'EOSResourceManageForm.delegate': 'DELEGATE',
    'EOSResourceManageForm.delegateCPU': 'DELEGATE CPU',
    'EOSResourceManageForm.delegateNET': 'DELEGATE NET',
    'EOSResourceManageForm.undelegate': 'UNDELEGATE',
    'EOSResourceManageForm.oversizeNET': 'Over the maximum size of NET',
    'EOSResourceManageForm.noSufficientNETToDelegate': 'No sufficient NET to delegate',
    'EOSResourceManageForm.noSufficientNETToUndelegate': 'No sufficient NET to undelegate',
    'EOSResourceManageForm.currentNETPrice': 'Current NET Price',
    'EOSResourceManageForm.enterNETAmountToStake': 'Enter NET Amount You Want To Stake',
    'EOSResourceManageForm.enterNETAmountToUnstake': 'Enter NET Amount You Want To Unstake',
    ...
    'EOSTransHistory.delegateBandwidth': 'Delegate Bandwidth',
    'EOSTransHistory.undelegateBandwidth': 'Undelegate Bandwidth',
    ...
    'EOSCreateAccountForm.invalidNameFormat': 'Invalid name format',
    'EOSCreateAccountForm.createAccount': 'Create Account',
    'EOSCreateAccountForm.newAccountName': 'New Account Name',
    'EOSCreateAccountForm.name': 'Name',
    'EOSCreateAccountForm.creator': 'Creator',
    'EOSCreateAccountForm.accountToFundAccount': 'Account Used To Fund The New Account',
    'EOSCreateAccountForm.ownerPublicKey': 'Owner Public Key',
    'EOSCreateAccountForm.ownerKey': 'Owner Key',
    'EOSCreateAccountForm.activePublicKey': 'Active Public Key',
    'EOSCreateAccountForm.activeKey': 'Active Key',
