const zh_CN = {
    ...
    'Restore.restoreFromSeedPhrase': '从助记词恢复钱包',
    'Restore.warning': '告警',
    'Restore.restoreNewWalletWillDeleteAllLocalData': '如果你从助记词恢复钱包，所有本地数据会被删除，程序会重新启动。请确认是否继续。',
    'Restore.continue': 'Continue',
    'Restore.allLocalDataWillBeLost': '所有本地数据都会被删除，包括但不限于当前的助记词、交易记录、导入的地址等等。确认要继续吗？',
