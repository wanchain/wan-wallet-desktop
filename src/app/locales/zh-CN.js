const zh_CN = {
    ...
    'EOSResourceManageForm.enterRAMSizeToBuy': '输入要购买的内存数量( KB )',
    'EOSResourceManageForm.selectReceivingAccount': '选择接收账户',
    'EOSResourceManageForm.enterRAMSizeToSell': '输入要卖出的内存数量( KB )',
    'EOSResourceManageForm.oversizeCPU': '超出CPU最大值',
    'EOSResourceManageForm.noSufficientCPUToDelegate': '没有足够的CPU进行质押',
    'EOSResourceManageForm.noSufficientCPUtoUndelegate': '没有足够的CPU退出质押',
    'EOSResourceManageForm.currentCPUPrice': '当前CPU价格',
    'EOSResourceManageForm.delegate': '质押',
    'EOSResourceManageForm.delegateCPU': '质押 CPU',
    'EOSResourceManageForm.delegateNET': '质押带宽',
    'EOSResourceManageForm.undelegate': '赎回',
    'EOSResourceManageForm.oversizeNET': '超出带宽最大值',
    'EOSResourceManageForm.noSufficientNETToDelegate': '没有足够的带宽进行质押',
    'EOSResourceManageForm.noSufficientNETToUndelegate': '没有足够的带宽赎回',
    'EOSResourceManageForm.currentNETPrice': '当前带宽价格',
    'EOSResourceManageForm.enterNETAmountToStake': '输入想要质押的带宽数量',
    'EOSResourceManageForm.enterNETAmountToUnstake': '输入想要赎回的带宽数量',
    ...
    'EOSTransHistory.delegateBandwidth': '质押带宽',
    'EOSTransHistory.undelegateBandwidth': '赎回带宽',
