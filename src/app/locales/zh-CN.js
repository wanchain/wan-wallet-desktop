const zh_CN = {
    ...
    'Config.addTokenETH': '添加ERC20代币信息',
    'Config.addTokenWAN': '添加WRC20代币信息',
    ...
    'SignMessage.input': '输入您的数据',
    'SignMessage.sign': '签名数据',
    'SignMessage.original': '原始数据',
    'SignMessage.signed': '签名后数据',
    'SignMessage.warn': '请选择签名账户并输入签名信息',
    'SignMessage.inputPlaceholder': '这是一个需要签名的信息，以证明你确实拥有此地址。',
