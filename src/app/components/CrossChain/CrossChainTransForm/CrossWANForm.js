...
class CrossWANForm extends Component {
  ...
  componentDidMount() {
    ...
    estimateCrossChainNetworkFee(type === INBOUND ? 'WAN' : 'ETH', type === INBOUND ? 'ETH' : 'WAN').then(res => {
    ...
    estimateCrossChainOperationFee(type === INBOUND ? 'WAN' : 'ETH', type === INBOUND ? 'ETH' : 'WAN').then(res => {
