      ...
      >
        <Form labelCol={{ span: 24 }} wrapperCol={{ span: 24 }} className="transForm">
          ...
          <Form.Item label={intl.get('AdvancedOptionForm.inputData')}>
            {getFieldDecorator('inputData', { initialValue: data, rules: [{ required: true, message: intl.get('AdvancedOptionForm.inputDataIsIncorrect'), validator: this.checkInputData }] })
              (<Input />)}
          </Form.Item>
        </Form>
      </Modal>
