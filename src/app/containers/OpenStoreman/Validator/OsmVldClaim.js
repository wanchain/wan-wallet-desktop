        ...
        >
          <div className="validator-bg">
            ...
            <CommonFormItem form={form} formName='validatorAccount' disabled={true}
              options={{ initialValue: '400000', rules: [{ required: true }] }}
              title='Deposit'
            />
            <CommonFormItem form={form} formName='validatorAccount' disabled={true}
              options={{ initialValue: '10000', rules: [{ required: true }] }}
              title='Reward'
            />
            <CommonFormItem form={form} formName='validatorAccount' disabled={true}
          ...
          <div className="validator-bg">
            ...
            <CommonFormItem form={form} formName='myAccount' disabled={true}
              options={{ initialValue: 0x7a815428f49f8fcf182fbd4bff102373f60ab70b }}
...
class OsmVldClaim extends Component {
  state = {
    visible: false
  }
