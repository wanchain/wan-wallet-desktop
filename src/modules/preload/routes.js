module.exports = {
    ...
    crossChain: ['initRegTokens', 'getTokensInfo', 'getCcTokensInfo', 'getTokenPairs', 'getChainInfoByChainId', 'getTwoWayBridgeTokensInfo', 'getCcTokenSelections', 'setCcTokenSelectStatus', 'updateTokensInfo', 'updateCcTokensInfo', 'updateTokensBalance', 'getTokenInfo', 'addCustomToken', 'deleteCustomToken', 'getSmgList', 'getHtmlAddr', 'crossBTC', 'crossETH', 'crossEOS', 'crossErc20', 'getAllUndoneCrossTrans', 'increaseFailedRetryCount', 'getAllCrossTrans', 'getRegisteredOrigToken'],
