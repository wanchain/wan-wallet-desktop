module.exports = {
    ...
    wallet: [ 'lock', 'unlock', 'getPubKey', 'getMnemHash', 'connectToLedger', 'deleteLedger', 'isConnected', 'getPubKeyChainId', 'signPersonalMessage', 'signTransaction', 'setUserTblVersion', 'reboot', 'exportPrivateKeys', 'importPrivateKey' ],
    ...
    crossChain: ['getRegisteredToken', 'initRegTokens', 'getTokensInfo', 'getCcTokensInfo', 'updateTokensInfo', 'updateCcTokensInfo', 'updateTokensBalance', 'getTokenInfo', 'addCustomToken', 'deleteCustomToken', 'getSmgList', 'getHtmlAddr', 'crossBTC', 'crossETH', 'crossEOS', 'crossErc20', 'getAllUndoneCrossTrans', 'increaseFailedRetryCount', 'getAllCrossTrans', 'getRegisteredOrigToken'],
    dappStore: ['getRegisteredDapp', 'getRegisteredAds', 'fetchService'],
    upgrade: ['start']
}
